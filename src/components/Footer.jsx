  ...
  return (
    <div>
      <footer className="w-full flex flex-col bg-[#f7f1db]">
        ...
        <div className="flex flex-col md:flex-row md:justify-end mx-4 text-center md:text-start md:mx-20 justify-between items-center py-6 border-t-2 border-gray-400 mt-10">
