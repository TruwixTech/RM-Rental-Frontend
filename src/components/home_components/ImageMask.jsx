...
const ImageMask = () => {
    return (
        ...
        <div className="container1">
            ...
            <div className="content">
                <div className='content-up'>
                    ...
                    <div className="upper">
                        <h2>Elevating your home with <span>uniquely fascinating <span style={{color : "#FFD74D"}}>furniture.</span></span></h2>
        ...
        <div className='fullbanner'>
            ...
            <h2>Elevating your home with <span>uniquely fascinating <span style={{color : "#FFD74D"}}>furniture.</span></span></h2>
            <div className='fullbanner-subtitle'>Discover, Explore, Inspire: Fascinate Your World</div>
