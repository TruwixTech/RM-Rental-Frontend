...
import sofaimage from '../../assets/img/banner.webp';
import fullbanner from '../../assets/img/bannerfull.webp'
import 'remixicon/fonts/remixicon.css';

const ImageMask = () => {
    useLayoutEffect(() => {
        const preloadImage = document.createElement("link");
        preloadImage.rel = "stylesheet";
        preloadImage.fetchpriority = "high";
        preloadImage.href = fullbanner;
    ...
    return (
        <div>
            ...
            <div className='fullbanner'>
                ...
                <div className='fullbanner-img'><img src={fullbanner} alt="Decorative" fetchPriority='high'/></div>
            </div>
        </div>
    );
};
